...
int main()
{
    ...
    system("cls");
    printf("\n ------------------  Welcome %s to Bout Quiz Game --------------------------",playername);
    printf("\n\n Here are some tips you might wanna know before playing:");
    printf("\n -------------------------------------------------------------------------");
    printf("\n >> There are 2 rounds in this Quiz Game,1st ROUND & 2nd ROUND");
    printf("\n >> In 1st round you will be asked a total of 5 questions to test your");
    printf("\n    general knowledge. You are eligible to play the game if you give atleast 3");
    printf("\n    right answers, otherwise you can't proceed further to the 2nd Round.");
    printf("\n >> Your game starts with 2nd ROUND. In this round you will be asked a");
    printf("\n    total of 20 questions. Each right answer will be awarded 10 points!");
    printf("\n    By this way you can score upto 200 points!!!!!..........");
...
void help()
{
    ...
    printf("\n -------------------------------------------------------------------------");
    printf("\n ......................... C program Quiz Game...........");
    printf("\n >> There are two rounds in the game, 1st round & 2nd ROUND");
    ...
    printf("\n >> Your game starts with the 2nd ROUND. In this round you will be asked");
    printf("\n    total 20 questions each right answer will be awarded 10 points.");
    printf("\n    By this way you can score upto 200 points and become a CHAMPION ...............");
    printf("\n >> You will be given 4 options and you have to press A, B ,C or D for the");
    printf("\n    right option");
